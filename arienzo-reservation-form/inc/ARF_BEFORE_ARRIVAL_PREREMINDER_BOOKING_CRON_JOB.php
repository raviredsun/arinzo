...
class ARF_BEFORE_ARRIVAL_PREREMINDER_BOOKING_CRON_JOB {
    ...
    public function init() {
        ...
        $prereminder = get_option("mphb_prereminder");

        if($prereminder){
            $date = date('Y-m-d',strtotime("+".$prereminder." days"));
            ...
            if($query->have_posts()) {
                ...
                foreach ($ids as $id) {
                    ...
                    $this->getSubject("mphb_email_customer_before_arrival_prereminder_booking_subject"),
                    $this->getMessage("mphb_email_customer_before_arrival_prereminder_booking_header", "mphb_email_customer_before_arrival_prereminder_booking_content", "mphb_email_footer_text"));
                }
            }
        }

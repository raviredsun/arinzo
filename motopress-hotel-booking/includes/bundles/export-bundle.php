...
class ExportBundle
{
    ...
    public function getBookingsExportColumns()
    {
        return apply_filters('mphb_export_bookings_columns', array(
            ...
            'product-name' => __('Product name', 'motopress-hotel-booking'),
            'product-price' => __('Product Price', 'motopress-hotel-booking'),
            'product-quantity' => __('Product Quantity sold', 'motopress-hotel-booking'),
            'product-total' => __('Product Total', 'motopress-hotel-booking'),
            ...
            'lunch' => __('Lunch Time', 'motopress-hotel-booking'),
            'beach_arrival_time' => __('Arrival Time', 'motopress-hotel-booking'),
            //'mphb_place' => __('Accommodation Place', 'motopress-hotel-booking'),
            'accommodation-place' => __('Accommodation Place', 'motopress-hotel-booking'),
            'table-sunbed-assigned' => __('Table/sunbed assigned', 'motopress-hotel-booking'),
        ));
    }
}

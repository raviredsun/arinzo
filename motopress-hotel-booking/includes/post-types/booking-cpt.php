...
class BookingCPT extends EditableCPT {
	...
	public function getFieldGroups(){
		...
		$customerGroupFields = array(
			...
			Fields\FieldFactory::create( 'hotel_name', array(
				'type'		 => 'text',
				'label'		 => __( 'Hotel Name', 'motopress-hotel-booking' ),
				'default'	 => '',
				)
			),
		...
		$giftGroupFields = array(
			Fields\FieldFactory::create( 'arf_is_gift', array(
				'type'		 => 'checkbox',
				'label'		 => __( 'Yes', 'motopress-hotel-booking' ),
				)
			)
		);

		$giftGroup->addFields( $giftGroupFields );

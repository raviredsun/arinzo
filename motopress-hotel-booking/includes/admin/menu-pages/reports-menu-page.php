            ...
            <div class="inside">
                <form id="mphb-export-bookings-form" class="mphb-export-form" method="POST">
                    <fieldset>
                        ...
                        <?php mphb_tmpl_select_html(array('name' => 'status'), $bookingStatuses, 'all',1); ?>
                    </fieldset>
                    <br/>
                    <fieldset>
				...
				<button class="button button-secondary" type="button" id="generate_arrival_time_pdf">Generate Arrival Time PDF</button>
                <button class="button button-secondary" type="button" id="generate_lunch_time_pdf">Generate Lunch Time PDF</button>
                <button class="button button-secondary" type="button" id="generate_lunch_arrival_times_pdf">Generate Lunch and Arrival Times PDF</button>
                <button class="button button-secondary" type="button" id="generate_product_report">Generate Product Report</button>
                <button class="button button-secondary" type="button" id="generate_product_report2">Generate Product Report CSV</button>
            </div>
        </div>
        <?php
    }

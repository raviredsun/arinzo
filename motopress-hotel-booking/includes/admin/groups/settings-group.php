...
class SettingsGroup extends InputGroup {
	...
	public function register(){
		add_settings_section( $this->getName(), $this->getLabel(), array( $this, 'render' ), $this->getPage() ,array(
			"before_section" => "<div class='settings_div_inner'>",
			"after_section" => "</div>",
			"section_class" => "settings_div",
		) );

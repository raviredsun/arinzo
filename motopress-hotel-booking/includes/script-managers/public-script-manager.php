...
class PublicScriptManager extends ScriptManager {
	...
	public function getLocalizeData(){
		...
		/* Qadisha - QD - 20221106 - Customize Home Page Calendar 
		   feeding: wp-content/plugins/motopress-hotel-booking/assets/js/public/mphb.js
		*/
		...
		$data = array(
			'_data' => array(
				'settings'			 => array(
					...
					'numberOfMonthCalendar'		 => 1,
					'numberOfMonthDatepicker'	 => 1,
					'showButtonPanelDatepicker'	 => false,

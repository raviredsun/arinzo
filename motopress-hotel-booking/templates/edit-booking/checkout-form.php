...
<div class="mphb-checkout-form-wrapper">
    <form class="" action="<?php echo esc_attr($actionUrl); ?>" method="POST">
        ...
        <p class="mphb-submit-button-wrapper">
            ...
            <a  class="button button-primary button-hero" href="<?php echo MPHB()->getEditBookingMenuPage()->getUrl( array( 'booking_id' => $_GET['booking_id'] , 'edit_accomodation' => 1 ) ) ?>">Edit Accomodation</a>
        </p>
    </form>
</div>
<?php
